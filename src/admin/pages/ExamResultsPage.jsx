    ...
    <section className="admin-page">
      <div className="admin-page-head">
        <div>
          ...
          <p>
            Eğitim kodu veya T.C. ile arayın. Kayıt başına en yüksek puan tutulur. ≥60 alanlar için ödeme işlemi{" "}
            <strong>Sınav Başarılı Ödemeler</strong> sayfasından yapılır. Yetkiler <strong>Rol ve Yetki</strong> içindeki{" "}
            <strong>Sınav Sonuçları</strong> modülünden verilir.
          </p>
        </div>
      </div>
